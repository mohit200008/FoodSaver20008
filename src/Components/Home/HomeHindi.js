        ...
        <div>
            <div className='home-page-container slides'>
                <div className='home-page-food-count-container '>
                    <h3 className='home-page-food-count-message msg1'><span className='message'>घर पर </span>आइटम</h3>
                    ...
                    <div>
                        <div className='home-page-container '>
                            ...
                            <div className=''>
                                <h3 className='home-page-food-count-message msg2'>एक्सपायर होने के बारे में खाना</h3>
