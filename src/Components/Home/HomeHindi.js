    ...
    foodsArray &&
      foodsArray.map((food) => {
        if (dateDifference(food.expiration_date) < 4) {
          ...
          dateDifference(food.expiration_date) > 3 &&
          dateDifference(food.expiration_date) < 7
        ) {
